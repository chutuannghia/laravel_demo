        ...
        <div class="col-lg-7">
            <div class="card shadow-lg border-0 rounded-lg mt-5">
                <div class="card-header">
                    <h3 class="text-center font-weight-light my-4">Thêm user Mới</h3>
                    @if (session('tb'))
                    ...
                    <form action="" method="post">
                        ...
                        <div class="mb-3">
                            <div class="form-floating mb-3">
                                <input class="form-control" name="name" type="text" placeholder="Nhập tên người dùng"/>
                            ...
                            <div class="form-floating my-3">
                                <input class="form-control" name="email" type="email" placeholder="Điạ chỉ email" />
                            ...
                            <div class="form-floating my-3">
                                <input class="form-control" name="quyen" type="text" placeholder="quyền" />
