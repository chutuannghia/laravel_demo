        ...
        <div class="col-lg-7">
            <div class="card shadow-lg border-0 rounded-lg mt-5">
                <div class="card-header">
                    <h3 class="text-center font-weight-light my-4">Sửa bình luận</h3>
                    @if (session('tb'))
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <select name="idtieude" class="form-select">
                                    @foreach ($dstt as $tt)
                                    @if ($tt->id == $cm[0]['idTinTuc'])
                                    <option value="{{$tt->id}}" selected>{{$tt->TieuDe}}</option>
                                    @else
                            ...
                            <div class="form-floating my-3">
                                <input class="form-control" name="noidung" type="text" placeholder="Nội dung " value="{{isset($cm[0]['NoiDung'])?$cm[0]['NoiDung']:''}}" />
